			...
			<view class="wrapper">
				...
				<view class="input-content">
					<view class="input-item">
						...
						<input type="text" placeholder="请输入手机号码" maxlength="11" name="nameValue" />
					</view>
					<view class="input-item">
						<text class="tit">密码</text>
						<input type="password" placeholder="8-18位不含特殊字符的数字、字母组合" name="passwordValue" placeholder-class="input-empty" />
					</view>
				</view>
