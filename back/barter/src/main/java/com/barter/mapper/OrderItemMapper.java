...
public interface OrderItemMapper {
	...
	@SelectProvider(type = com.barter.model.dyna.OrderItemDynaProvider.class, method = "updateProvider")
	Integer update(Map<String, Object> map);

	// 连表查询
	@SelectProvider(type = com.barter.model.dyna.OrderItemDynaProvider.class, method = "selectBySql")
	@Results({ 
 ...
 // 连表查询
 	@SelectProvider(type = com.barter.model.dyna.OrderItemDynaProvider.class, method = "select")
 	@Results({ 
 		@Result(column = "order_id", property = "orderId", jdbcType = JdbcType.VARCHAR, id = true),
 		@Result(column="order_item_id", property="orderItemId", jdbcType=JdbcType.VARCHAR, id=true),
 		@Result(column = "create_time", property = "create_time", jdbcType = JdbcType.TIMESTAMP),
