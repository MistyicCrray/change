...
public interface OrderMapper {
	...
	@UpdateProvider(type = com.barter.model.dyna.OrderDynaProvider.class, method = "updateProvider")
	int update(Map<String, Object> map);
	
	@SelectProvider(type = com.barter.model.dyna.OrderDynaProvider.class, method = "selectProvider")
	@Results({
        @Result(column="order_id", property="orderId", jdbcType=JdbcType.VARCHAR, id=true),
        @Result(column="addr_id", property="addrId", jdbcType=JdbcType.VARCHAR),
        @Result(column="user_id", property="userId", jdbcType=JdbcType.VARCHAR),
